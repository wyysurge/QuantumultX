...
Surge4.0: [Script]
http-response https:\/\/(api|api-cs)\.intsig\.net\/purchase\/cs\/query_property\? requires-body=1,max-size=0,script-path=https://github.com/xiaoming123m/QuantumultX/blob/master/NobyDa/Surge/JS/CamScanner.js
